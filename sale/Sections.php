...
$sql = "DELETE FROM Sections WHERE Sections_Id=$id";

if ($link->query($sql) === TRUE) {

$Alert_Class = "success";
$Alert_Text  = "تم حذف المنتج بنجاح...!";

} else {
$Alert_Class = "danger";
$Alert_Text  = "هناك مشكلة في حذف المنتج الرجاء المحاولة لاحقا...!";
}
...
?>
<tr>
<th><div class="avatar avatar-lg">
<img src="<?php echo $row["Sections_Icon"]; ?>">
</div>
</th>
<td><?php echo $row["Sections_Name"]; ?></td>
<td><button type="button" class="btn btn-outline-success" data-bs-toggle="modal"
data-bs-target="#ShowDes<?php echo $row["Sections_Id"]; ?>">
الوصف
</button>

</td>
<!--scrolling content Modal -->
<div class="modal fade" id="ShowDes<?php echo $row["Sections_Id"]; ?>" tabindex="-1" role="dialog"
aria-labelledby="ShowDes<?php echo $row["Sections_Id"]; ?>Title" aria-hidden="true">
<div class="modal-dialog modal-dialog-scrollable" role="document">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="ShowDes<?php echo $row["Sections_Id"]; ?>Title">
<?php echo $row["Sections_Name"]; ?></h5>
...
<td>
<span class="badge bg-primary"><?php echo $row["Sections_Sale"]; ?></span>
</td>
<td><?php echo $row["Sections_CreateTime"]; ?></td>
...
<button class="btn dropdown-item" >
  <a href="Edit_Section.php?id=<?php echo $row["Sections_Id"]; ?>">
...
<form method="POST">
<button value="<?php echo $row["Sections_Id"]; ?>" name="Delete" type="submit" class="btn dropdown-item" href="#">
