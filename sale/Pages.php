...
$Alert_Class = "success";
$Alert_Text  = " تم حذف الصفحة بنجاح ...!";

} else {
$Alert_Class = "danger";
$Alert_Text  = "هناك مشكلة في حذف الصفحة الرجاء المحاولة لاحقا...!";
}
...
<td> <a class="btn btn-outline-success" target="_blank" href="/Page?id=<?php echo $row["id"]; ?>"> مشاهدة الصفحة </a></td>
